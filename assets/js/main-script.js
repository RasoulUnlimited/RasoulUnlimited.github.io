...
// بهینه‌سازی: استفاده از throttle برای رویداد اسکرول برای بهبود عملکرد
...
}, 100)); // محدود کردن اجرای تابع اسکرول به هر 100 میلی‌ثانیه
...
window.addEventListener("scroll", throttle(() => { // بهینه‌سازی: استفاده از throttle
  if (window.scrollY > 300) {
      // نمایش پس از 300px اسکرول
